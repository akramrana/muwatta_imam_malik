...
public class HadithRVAdapter extends ListAdapter<HadithsModel, HadithRVAdapter.ViewHolder> {
    ...
    public HadithRVAdapter(FragmentActivity c, FavoriteViewModel favoriteViewModel) {
        super(DIFF_CALLBACK);
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View item = LayoutInflater.from(parent.getContext()).inflate(R.layout.hadith_list, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (model.getIs_favorite() == 1) {
            holder.bookmarkBtn.setCompoundDrawablesWithIntrinsicBounds(0, android.R.drawable.btn_star_big_on, 0, 0);
        } else {
            holder.bookmarkBtn.setCompoundDrawablesWithIntrinsicBounds(0, android.R.drawable.btn_star, 0, 0);
        }
        ...
        holder.bookmarkBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    if (model.getIs_favorite() == 0) {
                        FavoritesModel favoritesModel = new FavoritesModel(model.getHadithnumber());
                        favoriteViewModel.insert(favoritesModel);
                        Toast.makeText(c.getApplicationContext(), "Hadith added to your favorite", Toast.LENGTH_SHORT).show();
                        holder.bookmarkBtn.setCompoundDrawablesWithIntrinsicBounds(0, android.R.drawable.btn_star_big_on, 0, 0);
                    } else {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        Button bookmarkBtn, copyButton, shareButton;
