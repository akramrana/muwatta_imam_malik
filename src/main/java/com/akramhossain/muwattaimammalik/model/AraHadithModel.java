...
@Entity(tableName = "ara_hadiths")

public class AraHadithModel {
    ...
    public AraHadithModel(int hadithnumber, int arabicnumber, String text, String grades, String reference_book, String reference_hadith) {
