...
@Entity(tableName = "ben_hadiths")

public class BenHadithModel {
    ...
    public BenHadithModel(int hadithnumber, int arabicnumber, String text, String grades, String reference_book, String reference_hadith) {
